...
// 4. Inject 67 new dynamic metadata definitions into RAW_DYNAMIC_METADATA
const metadataDefinitions = [
  ...
  // ==================== VEICULOS (10 items) ====================
  {
    ...
    category: 'veiculos',
    icon: 'Car',
    tags: ['combustível', 'carro', 'álcool', 'posto', 'gasolina'],
    type: 'vei_flex',
    inputs: [
      { id: 'preco_alcool', label: 'Preço do Álcool (Etanol)', def: 3.89, type: 'number', pref: 'R$' },
      { id: 'preco_gasolina', label: 'Preço da Gasolina', def: 5.59, type: 'number', pref: 'R$' }
    ],
    outputs: [
      { id: 'vantagem', label: 'Combustível Vantajoso', isPrimary: true },
      { id: 'proporcao', label: 'Proporção de Preço', suff: '%' }
    ],
    faq: [
      { q: 'Como funciona a regra dos 70%?', a: 'O motor flex consome mais etanol do que gasolina por quilômetro rodado. Geralmente, se o preço do etanol for inferior a 70% do preço da gasolina, vale a pena abastecer com etanol.' }
    ]
  },
  {
    ...
    category: 'veiculos',
    icon: 'Car',
    tags: ['combustível', 'viagem', 'consumo', 'posto'],
    type: 'vei_consumption',
    inputs: [
      { id: 'distancia', label: 'Distância da Viagem', def: 150, type: 'number', suff: 'km' },
      { id: 'consumo', label: 'Consumo Médio (Km/L)', def: 12, type: 'number', suff: 'Km/L' },
      { id: 'preco', label: 'Preço do Combustível', def: 5.59, type: 'number', pref: 'R$' }
    ],
    outputs: [
      { id: 'custo_total', label: 'Custo Total Estimado', pref: 'R$', isPrimary: true },
      { id: 'litros_necessarios', label: 'Combustível Necessário', suff: ' Litros' }
    ],
    faq: [
      { q: 'Como melhorar a média de consumo do carro?', a: 'Mantenha os pneus calibrados de acordo com o manual, evite acelerações bruscas, não carregue peso desnecessário e faça revisões periódicas no motor.' }
    ]
  },
  {
    id: 'ipva-estimado',
    ...
    category: 'veiculos',
    icon: 'Car',
    tags: ['ipva', 'carro', 'moto', 'impostos'],
    type: 'vei_ipva',
    inputs: [
      { id: 'valor_fipe', label: 'Valor de Tabela FIPE do Veículo', def: 50000, type: 'number', pref: 'R$' },
      { id: 'aliquota', label: 'Alíquota IPVA do Estado', def: 4.0, type: 'select', op: [{v: 4.0, l: 'SP / RJ / MG (4.0%)'}, {v: 3.0, l: 'PR / RS / PE (3.0%)'}, {v: 2.0, l: 'SC / BA / CE (2.0%)'}, {v: 1.0, l: 'AC / ES / Roraima (1.0%)'}] }
    ],
    outputs: [
      { id: 'ipva_devido', label: 'IPVA Estimado a Pagar', pref: 'R$', isPrimary: true }
    ],
    faq: [
      { q: 'Como funciona o pagamento do IPVA?', a: 'O IPVA pode ser pago em cota única com desconto (geralmente de 3% a 10%) ou parcelado em até 3 ou 5 vezes dependendo do estado brasileiro.' }
    ]
  },
  {
    id: 'depreciacao-fipe',
    ...
    category: 'veiculos',
    icon: 'Car',
    tags: ['fipe', 'depreciação', 'carro', 'venda'],
    type: 'vei_depreciation',
    inputs: [
      { id: 'valor_atual', label: 'Valor Atual do Veículo', def: 60000, type: 'number', pref: 'R$' },
      { id: 'anos', label: 'Tempo de Uso do Veículo', def: 3, type: 'number', suff: 'anos' },
      { id: 'categoria', label: 'Categoria do Veículo', def: 'popular', type: 'select', op: [{v: 'popular', l: 'Popular / Hatch'}, {v: 'suv', l: 'SUV / Sedan Médio'}, {v: 'importado', l: 'Importado de Luxo'}] }
    ],
    outputs: [
      { id: 'valor_final', label: 'Valor Estimado Futuro', pref: 'R$', isPrimary: true },
      { id: 'perda_total', label: 'Desvalorização Acumulada', pref: 'R$' }
    ],
    faq: [
      { q: 'O que acelera a desvalorização de um carro?', a: 'A alta quilometragem anual, falta de revisões carimbadas no manual, acidentes (sinistros) registrados e modificações estéticas não originais.' }
    ]
  },
  {
    id: 'custo-km-rodado',
    ...
    category: 'veiculos',
    icon: 'Car',
    tags: ['reembolso', 'quilometragem', 'km', 'trabalho'],
    type: 'vei_km_reimbursement',
    inputs: [
      { id: 'km_rodado', label: 'Quilômetros Rodados', def: 500, type: 'number', suff: 'km' },
      { id: 'reembolso_km', label: 'Valor de Reembolso por Km', def: 0.85, type: 'number', pref: 'R$' }
    ],
    outputs: [
      { id: 'reembolso_total', label: 'Valor Total do Reembolso', pref: 'R$', isPrimary: true }
    ],
    faq: [
      { q: 'Como é calculado o valor ideal por km rodado?', a: 'Leva em consideração o preço médio do combustível, o desgaste proporcional de pneus (jogo novo / km útil), revisões preventivas periódicas e desvalorização do veículo.' }
    ]
  },
  {
    ...
    category: 'veiculos',
    icon: 'Car',
    tags: ['financiamento', 'carro', 'cdc', 'banco'],
    type: 'vei_finance',
    inputs: [
      { id: 'valor_veiculo', label: 'Valor do Veículo', def: 50000, type: 'number', pref: 'R$' },
      { id: 'entrada', label: 'Valor de Entrada / Sinal', def: 15000, type: 'number', pref: 'R$' },
      { id: 'taxa_mensal', label: 'Taxa de Juros Mensal (a.m.)', def: 1.8, type: 'number', suff: '%' },
      { id: 'parcelas', label: 'Quantidade de Parcelas', def: 48, type: 'number', suff: 'meses' }
    ],
    outputs: [
      { id: 'valor_parcela', label: 'Prestação Mensal (CDC)', pref: 'R$', isPrimary: true },
      { id: 'total_pago', label: 'Valor Total Pago (Financiado)', pref: 'R$' },
      { id: 'juros_totais', label: 'Juros Totais Pagos', pref: 'R$' }
    ],
    faq: [
      { q: 'O que é o financiamento tipo CDC?', a: 'No Crédito Direto ao Consumidor (CDC), o comprador pega um empréstimo direto com o banco para pagar o vendedor e o veículo fica alienado ao banco até a quitação da última parcela.' }
    ]
  },
  {
    id: 'seguro-perfil',
    ...
    category: 'veiculos',
    icon: 'Car',
    tags: ['seguro', 'sinistro', 'perfil', 'trânsito', 'carro'],
    type: 'vei_insurance',
    inputs: [
      { id: 'valor_veiculo', label: 'Valor de Mercado do Veículo', def: 60000, type: 'number', pref: 'R$' },
      { id: 'idade_perfil', label: 'Perfil do Condutor', def: 'adulto', type: 'select', op: [{v: 'jovem', l: 'Jovem (< 25 anos)'}, {v: 'adulto', l: 'Adulto (> 25 anos)'}] },
      { id: 'garagem', label: 'Possui Garagem Fechada?', def: 'sim', type: 'select', op: [{v: 'sim', l: 'Sim'}, {v: 'nao', l: 'Não / Estaciona na Rua'}] }
    ],
    outputs: [
      { id: 'seguro_estimado', label: 'Prêmio do Seguro Anual', pref: 'R$', isPrimary: true },
      { id: 'franquia_estimada', label: 'Valor Estimado da Franquia', pref: 'R$' }
    ],
    faq: [
      { q: 'O que mais altera o valor do seguro?', a: 'A idade do motorista principal (jovens pagam mais), a cidade/bairro de residência (devido a índices de furto) e a presença de garagem coberta em casa e no trabalho.' }
    ]
  },
  {
    id: 'tempo-viagem',
    ...
    category: 'veiculos',
    icon: 'Car',
    tags: ['viagem', 'estrada', 'velocidade', 'tempo'],
    type: 'vei_travel_time',
    inputs: [
      { id: 'distancia', label: 'Distância a Percorrer', def: 240, type: 'number', suff: 'km' },
      { id: 'velocidade', label: 'Velocidade Média Esperada', def: 80, type: 'number', suff: 'km/h' },
      { id: 'paradas', label: 'Tempo de Paradas/Pedágios', def: 20, type: 'number', suff: 'minutos' }
    ],
    outputs: [
      { id: 'tempo_total_horas', label: 'Tempo Estimado de Viagem', suff: ' horas', isPrimary: true }
    ],
    faq: [
      { q: 'Como manter uma velocidade média segura?', a: 'Respeite a sinalização da rodovia. Lembre-se de que a velocidade média cai devido a pedágios, trânsito urbano na saída das cidades e ultrapassagens de caminhões lentos.' }
    ]
  },
  {
    id: 'rateio-pedagio',
    ...
    category: 'veiculos',
    icon: 'Car',
    tags: ['rateio', 'pedágio', 'amigos', 'carona'],
    type: 'vei_toll_split',
    inputs: [
      { id: 'custo_combustivel', label: 'Custo de Combustível da Viagem', def: 120, type: 'number', pref: 'R$' },
      { id: 'custo_pedagio', label: 'Custo Total de Pedágios', def: 45, type: 'number', pref: 'R$' },
      { id: 'passageiros', label: 'Número de Pessoas no Carro', def: 4, type: 'number', suff: 'pessoas' }
    ],
    outputs: [
      { id: 'custo_por_pessoa', label: 'Custo Individual Compartilhado', pref: 'R$', isPrimary: true },
      { id: 'custo_total', label: 'Custo Total da Viagem', pref: 'R$' }
    ],
    faq: [
      { q: 'Como dividir pedágios de forma prática?', a: 'Soma-se todas as tarifas de pedágio do trajeto de ida e volta e divide-se de forma igualitária entre todos os integrantes da viagem (carona amigável).' }
    ]
  },
  {
    id: 'manutencao-carro',
    ...
    category: 'veiculos',
    icon: 'Car',
    tags: ['manutenção', 'revisão', 'oficina', 'óleo'],
    type: 'vei_maintenance',
    inputs: [
      { id: 'quilometragem', label: 'Quilometragem do Carro', def: 50000, type: 'number', suff: 'km' },
      { id: 'tempo_revisao', label: 'Tempo desde a Última Revisão', def: 12, type: 'number', suff: 'meses' }
    ],
    outputs: [
      { id: 'custo_preventiva', label: 'Custo de Revisão Preventiva', pref: 'R$', isPrimary: true },
      { id: 'itens_troca', label: 'Recomendação de Itens a Trocar' }
    ],
    faq: [
      { q: 'Com qual frequência devo fazer a revisão?', a: 'A cada 10.000 km rodados ou a cada 12 meses (o que ocorrer primeiro). É a regra de ouro recomendada pelas montadoras para garantir a durabilidade de peças mecânicas.' }
    ]
  },
...
// 5. Inject calculation formulas for all 67 new types inside calculateFn
// Find the first occurrence of `return results;` inside `buildDynamicCalculators`.
const returnMarker2 = "return results;";
const endMaintIdx = content.indexOf(returnMarker2);
...
`;
  ...
  console.error('Error: Could not locate return results; block.');
}
